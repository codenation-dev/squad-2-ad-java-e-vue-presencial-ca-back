...
public interface LogMapper {
    ...
    @Mappings({
            ...
            @Mapping(source = "customer.user.id", target = "createdBy.id"),
            @Mapping(source = "customer.user.email", target = "createdBy.email"),
            @Mapping(source = "customer.user.fullName", target = "createdBy.fullName"),
    })
